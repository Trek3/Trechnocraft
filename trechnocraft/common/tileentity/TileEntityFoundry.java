...
import mods.trechnocraft.common.FoundryRecipes;
...
public class TileEntityFoundry extends TileEntity implements ISidedInventory, net.minecraftforge.common.ISidedInventory
{
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                BlockFoundry.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack itemstack = FoundryRecipes.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
